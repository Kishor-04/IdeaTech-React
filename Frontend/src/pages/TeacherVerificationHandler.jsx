...
function TeacherVerificationHandler() {
  ...
  useEffect(() => {
    const verifyEmail = async () => {
      ...
      try {
        const url = `${import.meta.env.VITE_API_URL}/teacherAuth/teacher-verify-email/${token}`;
...
export default TeacherVerificationHandler;
