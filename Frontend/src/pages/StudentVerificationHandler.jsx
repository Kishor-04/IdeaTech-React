...
function StudentVerificationHandler() {
  ...
  useEffect(() => {
    const verifyEmail = async () => {
      ...
      try {
        const url = `${import.meta.env.VITE_API_URL}/studentAuth/student-verify-email/${token}`;
...
export default StudentVerificationHandler;
